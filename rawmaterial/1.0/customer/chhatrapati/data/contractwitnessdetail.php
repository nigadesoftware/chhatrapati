...
<html>
    ...
    <body>
        ...
        <article class="w3-container">
            ...
            <?php
                $query = "select f.*,d.name_eng as witnessname_eng,d.name_unicode as witnessname_unicode from contractwitnessdetail f, servicecontractor s, personnamedetail p, namedetail d where f.active=1 and s.active=1 and p.active=1 and d.active=1 and f.witnessid=s.servicecontractorid and s.personnamedetailid=p.personnamedetailid and p.namedetailid=d.namedetailid and f.contractid = ".$contractid_de." and f.contractwitnessdetailid=".$contractwitnessdetailid_de;
                //echo $query;
                ...
                if ($row = oci_fetch_array($result,OCI_ASSOC+OCI_RETURN_NULLS))
                {
                    ...
                    //}
                        ...
                        {
                            echo '<tr>';
                            echo '<td><label for="witnessid">Witness</label></td>';
                            echo '</tr>';
                        }
                        else
                        {
                            echo '<tr>';
                            echo '<td><label for="witnessid">साक्षीदार</label></td>';
                            echo '</tr>';
                        }
                        echo '<tr>';
                        echo '<td><input type="text" style="font-size:12pt;height:30px" name="witness" id="witness" value="'.$row['WITNESSNAME_ENG'].'" STYLE="WIDTH:300PX"></td>';
                        echo '<td><label for="witnessid">*</label></td>';
                        echo '<td><input type="hidden" style="font-size:12pt;height:30px" name="witnessid" id="witnessid" value="'.$row['WITNESSID'].'"></td>';
                        echo '</tr>';
                ...
                else
                {
                    ...
                    echo '<tr>';
                    echo '<td><input type="text" style="font-size:12pt;height:30px" name="witness" id="witness" style="width:300px"></td>';
                    echo '<td><label for="witnessid">*</label></td>';
                    echo '<td><input type="hidden" style="font-size:12pt;height:30px" name="witnessid" id="witnessid"></td>';
                    echo '</tr>';
