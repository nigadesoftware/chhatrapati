		...
		if ($contract1->fetch($contractid))
		{
            ...
            if ($contract1->contractcategoryid == 521478963)
            {
                ...
                $pdf->MultiCell(
                    185,
                    6,
                    'ची पुस्तके पाहिली असून त्यांच्या करारावरुण घेणेप्रमाणे आपले सुचनेनुसार वाहतूकदार व तोडणीदार यांची वाहने प्रत्यक्ष पाहिली असता ती व्यवस्थित असून ऊस तोडणीसाठी आवश्यक माहिती घेतली आहे. तोडणी मुकादम यांना वाहतूकदारांनी रक्कम देऊन टोळीची बांधणी केलेली आहे तसेच त्यांना ॲडव्हान्स रक्कम देण्यास शिफारस करण्यात येत आहे.',
                    0,
                    'L'
                );
