...
<html>
    <head>
        ...
        <meta property="og:image" content="http://www.swapp.co.in/img/financialaccounting.png">
        ...
        <div class="row">
            <div class="box">
                ...
                <div style="float:left">
                      <img border="0" alt="ERP Consultancy" src="../img/financialaccounting.png">
                        <p>
                        We offer customised web based ERP for Sugar and Allied Industry.
                        1.We have plenty of experience of software developement and implementations
                        in sugar industry.
                        2.Advancements in technology enabled us to develop the
                        solutions for Sugar sector.
                        3.Unicode based out 
                        </p>
        </div>
        </div>
