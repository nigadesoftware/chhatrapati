<?php
	...
	$query = "insert into misuserresponsibility(misuserid,misresponsibilityid,misfactoryid,misactive,cruserid,crdatetime) values ($misuserid,$misresponsibilityid,".$_SESSION['factorycode'].",1,".$_SESSION["usersid"].",'".currentdatetime()."')";
